...
// Opentelemetry annotations import
...
public class TodobackendApplication {
	...
	// Opentelemetry annotation to create a span for this method and add the "todo" parameter as an attribute to the span
	@WithSpan
	// Alternatively, it can be configured by environment variable:
